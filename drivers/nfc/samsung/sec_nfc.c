...
//add i2c runin test by humingming
extern int i2c_devinfo_device_write(char *buf); 

//c01 device not add nfc driver add by humingming
        ...
        const struct i2c_device_id *id)
{
	...
	//add i2c runin test by humingming begin
	...
	//add i2c runin test by humingming end
