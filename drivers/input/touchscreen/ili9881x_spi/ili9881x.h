...
#define SPI_ESD_GESTURE_RUN				0xA67C9DFE //0x5B92E7F4
...
struct ilitek_ts_data {
	...
	/* Notify i2c to wait int before receive. */
	bool i2c_cmd_int;
	...
	int  (*wrapper)(u8* wdata, u32 wlen, u8* rdata, u32 rlen, bool irq);
...
extern struct ilitek_ts_data *ili9881x_ts;
...
extern void ili_fw_dump_iram_data(u32 start, u32 end, bool save);
...
extern void ili_ic_get_pc_counter_forwdt(void);

extern int ili_ic_check_int_stat(void);
...
extern void ili_interface_dev_exit(struct ilitek_ts_data *ili9881x_ts);
