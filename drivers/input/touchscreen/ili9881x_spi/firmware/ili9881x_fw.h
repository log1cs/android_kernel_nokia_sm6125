...
#define DEF_INI_NAME_PATH		"/vendor/firmware/ili9881x_ts_InnoLux_mp.ini"
#define DEF_FW_FILP_PATH		"/sdcard/ILITEK_FW"
#define DEF_INI_REQUEST_PATH	"ili9881x_ts_InnoLux_mp.ini"
#define DEF_FW_REQUEST_PATH		"ili9881x_ts_InnoLux_fw.hex"
static unsigned char CTPM_FW_DEF[] = {
	#include "firmware/NOKIA_INX_655_LongV_V0xCE.0x09_AP_0x05_MP_20200311.ili"
};
