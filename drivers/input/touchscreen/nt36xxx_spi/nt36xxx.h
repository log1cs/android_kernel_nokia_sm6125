...
//incell panel.regulator are same with LCD(VDDIO,AVDD)
#define TOUCHPAD_REGULATOR  1
//enable regulator always on
#define SLEEP_POWER_ENABLE  0
...
#define NVT_TOUCH_ESD_CHECK_PERIOD 2500	/* ms */
#define NVT_TOUCH_WDT_RECOVERY 1

#ifdef CONFIG_TOUCHSCREEN_USB_CHECK
#define NVT_USB_CHECK_STATE
#endif
